...
print("CMD_READ_MULTILINE == ", CMD_READ_MULTILINE)
print("CMD_SET_LINE_LENGTH == ", CMD_SET_LINE_LENGTH)
print("CMD_SET_LINE_NUMBER == ", CMD_SET_LINE_NUMBER)
print("CMD_SET_TIMER == ", CMD_SET_TIMER, "\n")
